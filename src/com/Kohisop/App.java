...
public class App {
    ...
    static class MenuItem {
        String kode; String nama; int harga; String kategori;
        MenuItem(String kode, String nama, int harga, String kategori) {
            this.kode = kode; this.nama = nama; this.harga = harga; this.kategori = kategori;
        }
    }

    static class OrderItem {
        String kode; String nama; int harga; int jumlah; String kategori;
        OrderItem(String kode, String nama, int harga, int jumlah, String kategori) {
            this.kode = kode; this.nama = nama; this.harga = harga; this.jumlah = jumlah; this.kategori = kategori;
        }
    }

    static class Member {
        String kode; String nama; int poin;
        Member(String kode, String nama, int poin) {
            this.kode = kode; this.nama = nama; this.poin = poin;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (in.nextLine().trim().equalsIgnoreCase("Y")) {
                ...
                if (currentMember != null) System.out.println("Selamat datang kembali, " + currentMember.nama + "!");
                else System.out.println("Member tidak ditemukan. Lanjut sebagai Non-Member.");
            } else {
